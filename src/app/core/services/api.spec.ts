...
describe('Api service', () => {
  ...
  describe('#GET', () => {
    ...
    it('should return expected answer (called once)', () => {
      ...
      api.get(mockEndPoint, search, false, headers).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        fail
      );

      const req = httpTestingController.expectOne(`${host}${mockEndPoint}?foo=bar`);
    ...
    it('should return error on server-error (called once)', () => {
      ...
      api.get(mockEndPoint).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        error => expect(error.status).toEqual(500, 'should return 500 error code')
      );
  ...
  describe('#POST', () => {
    ...
    it('should return expected answer (called once)', () => {
      ...
      api.post(mockEndPoint, body, true, headers).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        fail
      );
    ...
    it('should return error on server-error (called once)', () => {
      ...
      api.post(mockEndPoint).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        error => expect(error.status).toEqual(500, 'should return 500 error code')
      );
  ...
  describe('#PUT', () => {
    ...
    it('should return expected answer (called once)', () => {
      ...
      api.put(mockEndPoint, body, headers).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        fail
      );
    ...
    it('should return error on server-error (called once)', () => {
      ...
      api.put(mockEndPoint).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        error => expect(error.status).toEqual(500, 'should return 500 error code')
      );
  ...
  describe('#DELETE', () => {
    ...
    it('should return expected answer (called once)', () => {
      ...
      api.delete(mockEndPoint, headers).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        fail
      );
    ...
    it('should return error on server-error (called once)', () => {
      ...
      api.delete(mockEndPoint).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        error => expect(error.status).toEqual(500, 'should return 500 error code')
      );
  ...
  describe('#emptyResult', () => {
    ...
    it('should turn 505 into an empty  result', () => {
      ...
      api.get(mockEndPoint).pipe(
        catchError(api.emptyResult<IMockNotOkResponse>(expectedAnswer))
      ).subscribe(
        answer => expect(answer).toEqual(expectedAnswer, 'should return expected heroes'),
        fail
      );
