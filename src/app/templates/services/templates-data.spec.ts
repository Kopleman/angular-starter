...
import {
  ITemplate,
  ITemplateCreateReq,
  ITemplateFilters, ITemplateGulpStatusResponse,
  ITemplateResponse
...
describe('Templates data service', () => {
    ...
    it('should return status on request', () => {
      templatesData.updateSettings(template)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#changeGulpStatus', () => {
    ...
    it('should return gulp status', () => {
      templatesData.changeGulpStatus(templateId, expectedAnswer.status)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#delete', () => {
    ...
    it('should return status on delete request', () => {
      templatesData.delete(templateId)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#refreshSettings', () => {
    ...
    it('should return status on request', () => {
      templatesData.refreshSettings(templateId)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#refreshCloneSettings', () => {
    ...
    it('should return status on request', () => {
      templatesData.refreshCloneSettings(templateId)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#compileClones', () => {
    ...
    it('should return status on request', () => {
      templatesData.compileClones(templateId)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#publishDemo', () => {
    ...
    it('should return status on request and have right mode(normal) in params', () => {
      mode = 'normal';
      templatesData.publishDemo(templateId, mode)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#createTemplate', () => {
    ...
    it('should return status on request', () => {
      templatesData.createTemplate(data)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
  ...
  describe('#createClone', () => {
    ...
    it('should return status on request', () => {
      templatesData.createClone(templateId, cloneName, author, pageLess)
        .subscribe(
          answer =>
            expect(answer).toEqual(
              expectedAnswer,
